...
public class GitHubSession extends AbstractSession {
	...
	public static ISession createWithOAuth(String clientId, String clientSecret, List<String> scopes, String username) {
	...
	private GitHubSession(String clientId, String clientSecret, List<String> scopes, String username) {
		super();
