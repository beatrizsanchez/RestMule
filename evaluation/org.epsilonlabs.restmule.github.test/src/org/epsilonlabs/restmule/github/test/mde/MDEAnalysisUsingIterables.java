...
import org.epsilonlabs.restmule.github.test.query.CodeSearchQuery;
...
public class MDEAnalysisUsingIterables extends GitHubTestUtil {
			...
			for (SearchCode initialResultItem : searchCodeList) {
				...
				if (!repoNameSet.contains(initialResultItemFullRepoName)) {
					...
					for (SearchCode resultItem : repoFiles) {
						...
						// commits of file
						List<Commits> commits = GitHubTestUtil
